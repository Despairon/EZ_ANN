...
namespace EZ_ANN_4_Letter_Recognition
{
    ...
    public delegate void Teaching(List<Neuron[]> ann_layers, double precision, TeachingSample teaching_sample, Teacher teacher);
    ...
    public class Teacher
    {
        ...
        private class Methods
        {
            ...
            private static void back_propagation(List<Neuron[]> ann_layers, double precision, TeachingSample teaching_sample, Teacher teacher)
            {
                ...
                double[] recalculated_weight_for_output_layer = new double[output_layer.Length*output_layer.Length];
                int ind = 0;
